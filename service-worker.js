// Build: 27.9.0 commercial-04-printer-scanner-integrated-v10
"use strict";

const APP_VERSION = "27.9.0";
const CACHE_PREFIX = "ldm-";
const SHELL_CACHE = `${CACHE_PREFIX}release27-9-0-commercial-04-integrated-shell-v10`;
const RUNTIME_CACHE = `${CACHE_PREFIX}release27-9-0-commercial-04-integrated-runtime-v10`;
...
self.addEventListener("fetch", event => {
    ...
    if(
        ...
        /\/js\/(?:local-time|global-system-navigation|peripheral-setup|peripheral-setup-embedded|onboarding-service|onboarding-wizard|onboarding-dashboard|error-monitor|error-monitor-admin|license-checkout-v2|license-v2-(?:config|client|guard|admin-config|admin)|reporting-(?:service|bootstrap))\.js$/i.test(url.pathname)
    ){
