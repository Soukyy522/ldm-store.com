// Build: 27.9.0 customer-tech-abstraction-v28.2.7
"use strict";

const APP_VERSION = "27.9.0";
const CACHE_PREFIX = "ldm-";
const SHELL_CACHE = `${CACHE_PREFIX}release27-9-0-customer-tech-abstraction-v28-2-7`;
