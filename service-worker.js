// Build: 27.9.0 commercial-02-onboarding-setup-wizard-v8
"use strict";

const APP_VERSION = "27.9.0";
const CACHE_PREFIX = "ldm-";
const SHELL_CACHE = `${CACHE_PREFIX}release27-9-0-commercial-02-onboarding-shell-v8`;
const RUNTIME_CACHE = `${CACHE_PREFIX}release27-9-0-commercial-02-onboarding-runtime-v8`;
...
self.addEventListener("fetch", event => {
    ...
    if(
        ...
        /\/js\/(?:local-time|global-system-navigation|onboarding-service|onboarding-wizard|onboarding-dashboard|error-monitor|error-monitor-admin|license-checkout-v2|license-v2-(?:config|client|guard|admin-config|admin)|reporting-(?:service|bootstrap))\.js$/i.test(url.pathname)
    ){
