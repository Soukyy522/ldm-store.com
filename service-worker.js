// Build: 27.9.0 server-contact-settings-v28.3.3
"use strict";

const APP_VERSION = "27.9.0";
const CACHE_PREFIX = "ldm-";
const SHELL_CACHE = `${CACHE_PREFIX}release27-9-0-server-contact-v28-3-3`;
...
self.addEventListener("fetch", event => {
    ...
    if(
        ...
        /\/js\/(?:local-time|developer-navigation|global-system-navigation|peripheral-setup|peripheral-setup-embedded|receipt-customizer-embedded|onboarding-service|onboarding-wizard|onboarding-dashboard|error-monitor|error-monitor-admin|support-center|privacy-center|edge-function-client|storage-retention|account-service|cloud-session-guard|license-checkout-v2|license-v2-(?:config|client|guard|admin-config|admin)|reporting-(?:service|bootstrap)|public-contact-config-v2833|homepage-feedback-contact-v2833|developer-contact-settings-v2833)\.js$/i.test(url.pathname)
    ){
