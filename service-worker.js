// Build: 27.9.0 Interactive 3 Mode Demo V28.10.0
"use strict";

const APP_VERSION = "27.9.0-v28.10.0";
const CACHE_PREFIX = "ldm-";
const SHELL_CACHE = `${CACHE_PREFIX}release27-9-0-interactive-3-mode-demo-v28-10-0`;
const RUNTIME_CACHE = `${CACHE_PREFIX}release27-9-0-interactive-3-mode-demo-runtime-v28-10-0`;
