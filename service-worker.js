// Build: 27.9.0 Master Shift + Ketidakhadiran Dashboard Theme Sync V28.5.1
"use strict";

const APP_VERSION = "27.9.0-v28.5.1";
const CACHE_PREFIX = "ldm-";
const SHELL_CACHE = `${CACHE_PREFIX}release27-9-0-master-shift-ketidakhadiran-v28-5-1`;
const RUNTIME_CACHE = `${CACHE_PREFIX}release27-9-0-master-shift-ketidakhadiran-runtime-v28-5-1`;
const SUPABASE_CDN = "https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2";

const APP_SHELL = [
    "./", "./homepage.html", "./index.html", "./dashboard.html", "./kasir.html", "./barang.html", "./absensi.html", "./master-shift.html", "./ketidakhadiran.html", "./attendance-exception.html", "./Purchase-Order.html", "./goods.receipt.html", "./multi-store.html",
