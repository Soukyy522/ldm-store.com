// Build: 27.9.0 commercial-04-receipt-customizer-integrated-v11
"use strict";

const APP_VERSION = "27.9.0";
const CACHE_PREFIX = "ldm-";
const SHELL_CACHE = `${CACHE_PREFIX}release27-9-0-commercial-04-receipt-shell-v11`;
const RUNTIME_CACHE = `${CACHE_PREFIX}release27-9-0-commercial-04-receipt-runtime-v11`;
...
const APP_SHELL = [
    ...
    "./assets/icons/maskable-512.png", "./style.css", "./css/global-responsive-navigation.css", "./css/peripheral-setup-embedded.css", "./css/help-center.css", "./css/multi-store-dashboard-theme.css", "./css/central-catalog-control.css", "./setting.js", "./employee-id.js",
...
self.addEventListener("fetch", event => {
    ...
    if(
        ...
        /\/js\/(?:local-time|global-system-navigation|peripheral-setup|peripheral-setup-embedded|receipt-customizer-embedded|onboarding-service|onboarding-wizard|onboarding-dashboard|error-monitor|error-monitor-admin|license-checkout-v2|license-v2-(?:config|client|guard|admin-config|admin)|reporting-(?:service|bootstrap))\.js$/i.test(url.pathname)
    ){
