// Build: 27.9.0 Safe Dummy Account V28.6.0
"use strict";

const APP_VERSION = "27.9.0-v28.6.0";
const CACHE_PREFIX = "ldm-";
const SHELL_CACHE = `${CACHE_PREFIX}release27-9-0-safe-dummy-account-v28-6-0`;
const RUNTIME_CACHE = `${CACHE_PREFIX}release27-9-0-safe-dummy-account-runtime-v28-6-0`;
