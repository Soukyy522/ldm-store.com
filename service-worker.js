// Build: 27.9.0 server-contact-settings-v28.3.2
"use strict";

const APP_VERSION = "27.9.0";
const CACHE_PREFIX = "ldm-";
const SHELL_CACHE = `${CACHE_PREFIX}release27-9-0-server-contact-v28-3-2`;
