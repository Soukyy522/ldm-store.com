// Build: 27.9.0 Customer Copy Cleanup + Production Demo UI V28.6.1
"use strict";

const APP_VERSION = "27.9.0-v28.6.1";
const CACHE_PREFIX = "ldm-";
const SHELL_CACHE = `${CACHE_PREFIX}release27-9-0-copy-cleanup-demo-ui-v28-6-1`;
const RUNTIME_CACHE = `${CACHE_PREFIX}release27-9-0-copy-cleanup-demo-ui-runtime-v28-6-1`;
