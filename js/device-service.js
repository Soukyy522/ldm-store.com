(function(){
    ...
    async function quota(){await ownerContext();const {data,error}=await client().rpc("ldm_my_license_quota");if(error)throw error;return data&&typeof data==="object"?data:null}
