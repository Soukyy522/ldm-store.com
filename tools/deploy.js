...
const DEFAULT_ORIGIN = 'https://locdaily.github.io';
const DEFAULT_PUBLIC_URL = 'https://locdaily.github.io';
...
async function main() {
  console.log('');
  console.log('LocDailyMar V28.3.5 - GITHUB PAGES ORIGIN HARDENING');
